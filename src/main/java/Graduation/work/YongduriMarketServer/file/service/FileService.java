...
public class FileService {
    ...
    public FileInfo update(Long id, MultipartFile file, ImageType imageType) {
        if (file.isEmpty()) {
            return Optional.of(new FileInfo()).get();
        }
        ...
        fileInfo.update(randomFileName, file.getOriginalFilename(),directoryName,fileExt,file.getSize());
