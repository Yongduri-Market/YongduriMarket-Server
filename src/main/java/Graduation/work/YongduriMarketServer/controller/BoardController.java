...
public class BoardController {
    ...
    //게시글 좋아요
    @PutMapping("/like")
    public ResponseEntity<Boolean> likeBoard(@AuthenticationPrincipal CustomUserDetails user, @RequestBody BoardRequestDto.LikeDto request) throws Exception {
    ...
    //게시글 좋아요 해제
    @PutMapping("/unlike")
    public ResponseEntity<Boolean> unlikeBoard(@AuthenticationPrincipal CustomUserDetails user, @RequestBody BoardRequestDto.UnLikeDto request) throws Exception {
